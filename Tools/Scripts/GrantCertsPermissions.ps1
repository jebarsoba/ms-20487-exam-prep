Function Grant-DefaultAppPoolPermission
{
Param(
    $targetCert
)
    if ($targetCert.HasPrivateKey)
    {
        $keyName=(($targetCert.PrivateKey).CspKeyContainerInfo).UniqueKeyContainerName
        $keyPath = "C:\ProgramData\Microsoft\Crypto\RSA\MachineKeys\"
        $fullPath=$keyPath+$keyName
        $acl=Get-Acl -Path $fullPath
        $permission="IIS AppPool\DefaultAppPool","Read","Allow"
...
$certs = Get-ChildItem Cert:\LocalMachine\My | Where-Object {$_.Issuer -like 'CN=Blue*'}
foreach($cert in $certs)
{
    Grant-DefaultAppPoolPermission $cert
}

# SIG # Begin signature block
# MIIaagYJKoZIhvcNAQcCoIIaWzCCGlcCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrvNfC4y+TKt79KYnOWWmegA9
# bJigghUvMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# SIb3DQEJBDEWBBSlmXlXOfRHkPajQtR/IUp68RtDCzBeBgorBgEEAYI3AgEMMVAw
...
# AQBQ0hQY9iP8F2bQiSw70+PzN1NCz/kenFlcon4vuS3sh9RNDgtN+meTZtYfSzRu
# 7JfYJBgvzD8YjKndS2iqTLFSGuRFxrneql0S0SFzVoIOifeKblRBKBeFfbC50fbP
# umcX8lt44gDaSnbmvCOfMpmh9X7EtYqhQamoCevIzrBzFg6e5YrF62SF95A5e1Bo
# NqJWwVBDRB6boaBgNdoRWeH0xODYr9UktbrdsIscT+uwBq2dZAMpNJLYPmdQiAZK
# yVtzk91tj0HfyaQnbgL9muUNMJDiE+ROjQOb/GlrRzD8Lhiu2mWWN8fM5lmZVG8G
# T4TMIx28aIclQ+zCvIzDc+/EoYICKDCCAiQGCSqGSIb3DQEJBjGCAhUwggIRAgEB
...
# 9w0BCQUxDxcNMTMwMTIxMjMxMDI1WjAjBgkqhkiG9w0BCQQxFgQUX5NSO1ws0gjH
# veqTb5bGjJWbGg0wDQYJKoZIhvcNAQEFBQAEggEAenIKSgP1vuTHX5W040BGe4+T
# OzmKtJktmsKn5lAn07QcqgJQ/GUrNx2GtxISxHTQqLsVyC3ZnSnULBvEMSazCAr5
# QdO/qtO0J4iiMmBn6sJmaTtq0FWRzOuq1jRoPuNbzfMXp15gR8kXAikbLVoR37No
# j4eCdDUCKRYv9uBbeXyFd33Dsx0d1qsYIEGCY3bzg+/wCbaoNoSO/dMcKyn+ccfh
# HUznfScUb275oMBjTyUvnrrJ2TPs/JOaZheaRK5vOsCluUKogj1B9atRAEOACQvE
# iSuVLEHR4UgVjhPYu6CEJL6ZhyR0RWbgwipUnd42S3Agxw9YEgIpE9WBSmKGTA==
